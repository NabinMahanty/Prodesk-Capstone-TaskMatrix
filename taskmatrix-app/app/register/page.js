...
function PasswordStrength({ password }) {
  ...
  return (
    <div style={{ marginTop: "0.5rem" }}>
      ...
      <span
        style={{ fontSize: "0.75rem", color: colors[score], fontWeight: 500 }}
      >
        {labels[score]}
      </span>
    </div>
        ...
        <main className="auth-form-panel">
          <div className="auth-form-box">
            ...
            <p className="auth-subtitle">
              Start managing projects like a pro — it&apos;s free.
            </p>
            ...
            >
              ...
              <div
                ...
                style={{ marginBottom: errors.terms ? "0.5rem" : "1.5rem" }}
              >
                <input
                  id="terms"
                  type="checkbox"
            ...
            <p className="auth-switch">
              ...
              <Link id="go-to-login" href="/login">
                {" "}
                Sign in
              </Link>
            </p>
