      ...
      <div className="auth-layout">
        ...
        <aside className="auth-brand-panel" aria-hidden="true">
          ...
          <h2 className="brand-headline">
            Your Projects,{' '}
            <span className="accent">Perfectly<br />Orchestrated.</span>
          </h2>
          <p className="brand-description">
            Experience the art of focused work. A digital sanctuary where complex
            workflows become elegant symphonies.
          </p>
        ...
        <main className="auth-form-panel">
          <div className="auth-form-box">
            ...
            <form onSubmit={handleLogin} noValidate aria-label="Email login form">
              {/* Email */}
            ...
            <p className="auth-switch">
              New to TaskMatrix?
              <Link id="go-to-register" href="/register"> Create an account</Link>
            </p>
